    ...
    return Row(
      children: [
        ...
        Expanded(
          child: Container(
            height: 2,
            color: currentStep > 0 ? AppColors.purple : AppColors.grey200,
          ),
        ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: isActive || isComplete ? AppColors.purple : AppColors.grey200,
      ),
      child: Center(
        child: isComplete
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? AppColors.purpleLight : AppColors.grey50,
          border: Border.all(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    title,
                    style: Theme.of(context).textTheme.titleMedium?.copyWith(
                      color: isSelected ? AppColors.purple : AppColors.grey900,
                      fontWeight: FontWeight.bold,
                    ),
                  ),
                  const Gap(4),
...
class _PasswordStrengthBar extends StatelessWidget {
  ...
  Color _getStrengthColor(int strength) {
    ...
    if (strength == 2) return AppColors.amber;
    return AppColors.teal;
  }

  String _getStrengthText(int strength) {
    if (strength == 0) return 'Kekuatan password: Lemah';
    if (strength == 1) return 'Kekuatan password: Lemah';
    if (strength == 2) return 'Kekuatan password: Sedang';
    if (strength == 3) return 'Kekuatan password: Kuat';
