part of '../views/attendance_view.dart';

class AttendanceSelectionForm extends StatelessWidget {
  final AttendanceController controller;

  const AttendanceSelectionForm({super.key, required this.controller});
                ...
                child: Obx(() => SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        onPressed: (controller.selectedKelas.value.isNotEmpty && controller.selectedMapel.value.isNotEmpty)
                            ? () => showQrDialog(Get.context!, controller)
                            : null,
...
class AttendanceStudentList extends StatelessWidget {
  ...
  const AttendanceStudentList({super.key, required this.controller});
...
void showQrDialog(BuildContext context, AttendanceController controller) {
